label khdDay1:
    ...
    menu lunch_choise:                                      #выбор с кем сесть на обеде
        "С кем сесть"
...
label khdBoyLunch:
    ...
    сказать, состояла на 99 процентов из чифира и на 1 процент из нефти, {w}и сразу же разбежался по организму, у
    сваиваться в разные органы"
    return
